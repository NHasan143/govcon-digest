...
interface CategoryBigArticlesProps extends Omit<ArticleListSectionProps, "articles"> {
  articles?: Article[];
  category?: Category;
  title?: string;
  ...
  return (
    <>
      ...
      <div className={`row position-relative vertical-divider overflow-visible mb-50 ${className || ""}`}>
          ...
          <div className="mb-30">
            <article className="first-post mb-md-4 mb-lg-0 mb-30">
              ...
              <figure className="mb-30">
                <Link href="/single">
                  <Image className="cover-image" src="/assets/imgs/news/news-23.jpg" alt="newsboard" width={906} height={417} />
                </Link>
              </figure>
            ...
            <article className="first-post mb-md-4 mb-lg-0 mb-30">
              ...
              <figure className="mb-30">
                <Link href="/single">
                  <Image className="cover-image" src="/assets/imgs/news/news-24.jpg" alt="newsboard" width={906} height={417} />
                </Link>
              </figure>
              <div className="post-content">
                <p className="excerpt">William Mellon Hitchcock was not your typical acid head. Billy, as he was called, was a tall, charming blonde stockbroker in his twenties who worked at Lehman Brothers, for one. He was heir to one of the largest fortunes in the country, for another.</p>
            ...
            <article className="first-post mb-md-4 mb-lg-0 mb-30">
              ...
              <figure className="mb-30">
                <Link href="/single">
                  <Image className="cover-image" src="/assets/imgs/news/news-25.jpg" alt="newsboard" width={906} height={417} />
                </Link>
              </figure>
              <div className="post-content">
                <p className="excerpt">William Mellon Hitchcock was not your typical acid head. Billy, as he was called, was a tall, charming blonde stockbroker in his twenties who worked at Lehman Brothers, for one. He was heir to one of the largest fortunes in the country, for another.</p>
            ...
            <div className="loop-grid-3">
              <article className="row ">
                <div className="col-md-6">
                  <figure className="mb-md-0 mb-sm-3">
                    <Link href="/single">
                      <Image className="cover-image" src="/assets/imgs/news/news-16.jpg" alt="newsboard" width={442} height={330} />
                    </Link>
                  </figure>
                </div>
                <div className="col-md-6">
              ...
              <article className="row ">
                <div className="col-md-6">
                  <figure className="mb-md-0 mb-sm-3">
                    <Link href="/single">
                      <Image className="cover-image" src="/assets/imgs/news/news-18.jpg" alt="newsboard" width={442} height={330} />
                    </Link>
                  </figure>
                </div>
                <div className="col-md-6">
        ...
        {showSidebar && <Sidebar display="d-none" />}
      </div>
    </>
  );
}
