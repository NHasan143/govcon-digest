/* Canonical news article page: /stories/{slug}/ — indexed. Same rendering as
   blog articles; the category is shown as metadata but stays out of the URL. */
...
export async function generateMetadata({ params }: Args): Promise<Metadata> {
    ...
    const canonical = `/stories/${post.slug}`
