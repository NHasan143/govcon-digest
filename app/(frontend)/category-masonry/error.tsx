...
export default function Error({ error, reset }: ErrorProps) {
    useEffect(() => {
        ...
        console.error('Category Masonry error caught:', error);
    }, [error]);
            ...
            <div className="max-w-md w-full bg-white p-8 text-center">
                <div className="mb-6">
                    ...
                    <h2 className="text-2xl font-bold text-gray-900 mb-2">
                        Category Masonry Error
                    </h2>
                    <p className="text-gray-600 mb-6">
                        We encountered an issue loading the masonry layout. Please try again or browse other categories.
                    </p>
                </div>
