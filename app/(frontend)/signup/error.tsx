...
export default function Error({ error, reset }: ErrorProps) {
    useEffect(() => {
        ...
        console.error('Signup page error caught:', error);
    }, [error]);
            ...
            <div className="max-w-md w-full bg-white p-8 text-center">
                <div className="mb-6">
                    ...
                    <p className="text-gray-600 mb-6">
                        We encountered an issue with the signup page. Please try again or continue browsing as a guest.
                    </p>
                </div>
                ...
                <div className="mt-30 mb-30">
                    ...
                    <Link
                        href="/login"
                        className="block w-full bg-green-600 text-white px-4 py-2 rounded-md hover:bg-green-700 transition-colors duration-200"
                    >
                        Sign in instead
                    </Link>
                </div>
